...
void setupInputs() {
    ...
    // Position verification sensor - moderate debounce for reliable detection during motion
    positionVerificationSensor.attach(Pins::POSITION_VERIFICATION_SENSOR);
    positionVerificationSensor.interval(25); // 25ms debounce for reliable sensor detection during motion
