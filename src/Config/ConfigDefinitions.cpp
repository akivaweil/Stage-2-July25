...
const float CUTTING_DISTANCE = 6.25;   // Exact distance to cut through material (from approach position)
const float TOTAL_FORWARD_DISTANCE = 24.3;  // Total exact distance from offset position to final position
